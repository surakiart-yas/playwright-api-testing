 ...
 *
 * Tests provision their own preconditions at runtime (see tests/products/provisioner.ts),
 ...
 * test mutates) — see docs/decisions.md §19 for the seeded-reference-data pattern.
 */
